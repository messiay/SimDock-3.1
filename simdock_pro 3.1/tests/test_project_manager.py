...
class TestProjectManager(unittest.TestCase):
    ...
    def test_load_project(self):
        ...
        self.assertEqual(self.project_manager.current_project_path, project_path)
    ...
    def test_add_ligands(self):
        ...
        stored_paths = self.project_manager.add_ligands(ligand_paths, copy_file=True)
    ...
    def test_get_project_summary(self):
        ...
        self.project_manager.add_ligands([self.test_ligand], copy_file=True)
